...
import { MapPin, ShieldAlert, Heart } from 'lucide-react';
...
const info = pet ? petInfo[pet.species?.toLowerCase()] : null;
    ...
    const handleAdoptionSubmit = (e) => {
        ...
        axios.post(
            'https://pet-adoption-server-gamma.vercel.app/requests',
            adoptionData,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">              
                <div className="lg:col-span-2 bg-blue-50 border rounded-3xl overflow-hidden shadow-xl p-6 space-y-6">
                    ...
                    <div className="flex flex-wrap justify-between items-center gap-4">
                        <div>
                            <h2 className="text-4xl font-black text-blue-900 flex items-center gap-2">
                                ...
                                <span className={`text-xs px-3 py-1 rounded-full border ${pet.status === 'adopted'
                                        ? 'bg-blue-300 text-blue-900 border-blue-500/20'
                                        : 'bg-purple-800 text-white border-emerald-500/20'
                                    }`}>
                        ...
                        <div className="text-right">
                            <p className="text-xs text-cyan-800 uppercase font-bold tracking-wider">
                                Adoption Fee
                            </p>
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-purple-900 leading-relaxed bg-indigo-100 p-4 rounded-xl">
                            {pet.description}
                        </p>
                    </div>
                </div>
                ...
                <div className="border border-indigo-300 rounded-3xl p-6 shadow-xl h-fit sticky top-24">
                    ...
                    <p className="text-sm text-indigo-800 mb-6">
                        Submit this application form to request adoption.
                    </p>
                    ...
                    {isOwner ? (
                        ...
                        <div className="border text-red-400 p-4 rounded-xl text-xs flex gap-2 items-start leading-relaxed">
                            ...
                            <span>
                                You are the manager/owner of this pet listing.
                                Adoption requests are disabled for owners.
                            </span>
                        </div>
                        ...
                        <div className="bg-blue-950/30 border border-blue-900/40 text-blue-400 p-4 rounded-xl text-xs flex gap-2 items-start leading-relaxed">
                            ...
                            <span>
                                This companion has been successfully adopted into another loving home.
                                Applications closed.
                            </span>
                        </div>
                        ...
                        <form onSubmit={handleAdoptionSubmit} className="space-y-4 text-xs">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    readOnly
                                    value={pet.name}
                                    className="w-full bg-indigo-200 hover:bg-indigo-800 p-3 rounded-xl text-purple-900 hover:text-white cursor-not-allowed font-medium focus:outline-none"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        required
                                        className="w-full bg-indigo-200 hover:bg-indigo-800 p-3 rounded-xl text-blue-800 hover:text-white font-medium focus:outline-none focus:border-emerald-500"
                                    />
                                </div>
                            </div>

                            <div>
                                <label className="block text-blue-900 text-sm font-semibold mb-1">
                                ...
                                <textarea
                                    ...
                                    rows="3"
                                    required
                                    className="w-full bg-indigo-200 p-3 rounded-xl text-gray-900 font-medium focus:outline-none focus:border-emerald-500 resize-none"
                                    placeholder="Tell the shelter why you are a great match for this pet..."
                                ></textarea>
                            </div>

                            <button
                                type="submit"
                                className="w-full bg-emerald-600 hover:bg-purple-900 text-white font-bold py-3.5 px-4 rounded-xl text-sm transition shadow-lg shadow-emerald-950/30"
                            >
                                Submit Application
                            </button>
